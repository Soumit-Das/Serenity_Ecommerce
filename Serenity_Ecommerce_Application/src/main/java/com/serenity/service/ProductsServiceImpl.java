...
public class ProductsServiceImpl implements ProductsService {
	...
	@Override
	public List<Products> searchByPriceRangeAndType(String productType, double startingPrice, double endingPrice)
			throws ProductsException {
		
		List<Products> list = productRepository.findByPriceRangeAndType(productType, startingPrice, endingPrice);
		return list;
		
	}

	@Override
	public List<Products> searchByDiscountPercentageRangeAndType(String productType, double startingDiscount,
			double endingDiscount) throws ProductsException {
		
		List<Products> list = productRepository.findByDiscountPercentageRangeAndType(productType, startingDiscount, endingDiscount);
		return list;
